...
public class CarEquipmentController {
    ...
    @Operation(
            ...
            description = "Add equipment to reservation"
    )
    @ApiResponses(
            value = {
                    @ApiResponse(
                    ...
                    @ApiResponse(
                            responseCode = "404",
                            description = "Equipment is not found"
    ...
    public ResponseEntity<Boolean> addEquipment(@PathVariable("code") int equipmentCode,@PathVariable("number") String resNum){
        try{
            Boolean isOk=reservationService.addEquipment(resNum,equipmentCode);
